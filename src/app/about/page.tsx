  ...
  return (
    <div className="bg-linear-to-r from-blue-400 via-blue-200 to-yellow-100">
        ...
        <div className="mx-10 lg:mx-40 my-5">
            ...
            <h2 className='font-semibold md:text-xl mt-10 my-2 text-blue-950'>Kontaktirajte nas</h2>
            <p className='mb-2'> Email: sveusluge@gmail.com</p>
            <p className='mb-2'> Broj telefona: 063 123 456</p>
        </div>
        <Footer></Footer>
    </div>
  )
