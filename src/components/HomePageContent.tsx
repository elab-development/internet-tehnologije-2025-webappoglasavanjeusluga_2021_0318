...
export default function HomePageContent({ categories }: Props) {
    ...
    return (
        <div>
            ...
            <div className="bg-linear-to-r from-blue-400 via-blue-200 to-blue-100">
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="flex flex-col gap-8 md:flex-row">
                        ...
                        <section  className="flex-1 flex flex-col items-center pb-10">
                            ...
                            <h1 id="usluge" className="mb-5 pt-25 mt-5 text-2xl font-semibold text-gray-800">USLUGE</h1>
                            {services.length === 0 ? (
                                <p className="text-center text-gray-500"> Nema usluga </p>) :
                                (
                                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 w-full">
                                        {services.map((service, id) => (
                                            <Card service={service} categories={categories} type={"services"} key={id}/>
                                        ))}
                                    </div>
                                )}
                        </section>
